...
def analyze_hackathon_profile(hackathon_data: dict, osint: dict, banner_bytes: bytes = None) -> dict:
    ...
    YOUR TASK:
    Analyze the themes, sponsors, and historical winning patterns. If a banner image is provided, inspect it for hidden sponsors or branding.
    ...
    result = generate_json_with_failover(prompt, image_bytes=banner_bytes, thinking=False)
