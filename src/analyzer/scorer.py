...
from src.analyzer.xai_explainer import explain_prediction  # noqa: E402
from src.logger import logger  # noqa: E402
from src.ml.embedder import EmbedderSingleton  # noqa: E402
from src.ml.predictor import predict_win_probability  # noqa: E402


def get_embedder():
    return EmbedderSingleton.get_model()
...
def score_idea(idea: dict, hackathon_data: dict) -> float:
    ...
    features = {
        ...
        "likes": 0,
        "team_size": 1,
        "sponsor_challenge_match": bool(idea.get("target_track")),
        "has_video_demo": True,
    ...
    logger.info(
        f"   📊 ФІНАЛ: ML={ml_score:.3f} | Judge={judge_score:.3f} | "
        f"Впевненість={confidence * 100:.1f}% -> Підсумок={final_score:.3f}"
    )
